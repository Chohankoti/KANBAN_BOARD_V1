...
export default function UpdateTask() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    console.log("Update task data ", formData);
    try {
      await axios.put(`http://localhost:8081/tasks/${id}`, JSON.stringify(formData), {
        headers: {
  ...
  return (
    <div class="flex flex-col w-screen h-screen overflow-auto text-gray-700 bg-gradient-to-tr from-blue-200 via-indigo-200 to-pink-200">
      <div className="px-10 mt-3">
        <h1 className="text-2xl font-bold flex flex-grow justify-center items-center">Update Task for {id}</h1>
      </div>
